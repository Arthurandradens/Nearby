package com.nlw.nearby.core.network

import com.nlw.nearby.core.network.KtorHttpClient.httpClientAndroid
import com.nlw.nearby.data.model.Category
import com.nlw.nearby.data.model.Coupon
import com.nlw.nearby.data.model.Market
import com.nlw.nearby.data.model.MarketDetails
...
object NearbyRemoteDataSource {
    ...
    private const val LOCAL_HOST_PHISICAL_BASE_URL = "http://192.168.3.29"
